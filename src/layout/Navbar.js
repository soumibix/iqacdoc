...
function Navbar() {
  return (
    <header class="antialiased">
      <nav class="bg-white px-4 lg:px-6 py-2.5 dark:bg-gray-800 rounded-xl">
            ...
            <form action="#" method="GET" class="hidden lg:block lg:pl-2">
              ...
              <div class="relative mt-1 lg:w-96">
                ...
                <input
                  ...
                  name="email"
                  id="topbar-search"
                  class="bg-gray-50 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  placeholder="Search"
                />
              </div>
            </form>
